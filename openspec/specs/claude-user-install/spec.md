# Spec: claude-user-install

## Purpose

Ensure Claude Code is installed in a user-owned npm prefix so the `dev` user has full write access, enabling Claude Code to auto-update itself without permission errors.
