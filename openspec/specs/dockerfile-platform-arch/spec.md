# Spec: dockerfile-platform-arch

## Purpose

Defines requirements for platform-aware (multi-architecture) builds in the Dockerfile, enabling correct tool installation for both arm64 and amd64 target architectures using Docker BuildKit's `TARGETARCH` argument.
